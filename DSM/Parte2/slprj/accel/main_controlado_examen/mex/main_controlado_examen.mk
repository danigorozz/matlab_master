###########################################################################
## Makefile generated for component 'main_controlado_examen'. 
## 
## Makefile     : main_controlado_examen.mk
## Generated on : Fri Jan 20 13:36:37 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/main_controlado_examen_acc.mexw64
...
PRODUCT_NAME              = main_controlado_examen
MAKEFILE                  = main_controlado_examen.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2021b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2021b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/Daniel/MATLAB/Projects/Master/DSM/Parte2
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = main_controlado_examen_comp.rsp
CMD_FILE                  = main_controlado_examen.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/main_controlado_examen_acc.mexw64
...
DEFINES_STANDARD = -DMODEL=main_controlado_examen -DNUMST=2 -DNCSTATES=38 -DHAVESTDIO -DMDL_REF_SIM_TGT=1
...
SRCS = $(START_DIR)/slprj/accel/main_controlado_examen/main_controlado_examen_acc.c $(START_DIR)/slprj/accel/main_controlado_examen/main_controlado_examen_acc_data.c $(START_DIR)/slprj/accel/main_controlado_examen/rtGetInf.c $(START_DIR)/slprj/accel/main_controlado_examen/rtGetNaN.c $(START_DIR)/slprj/accel/main_controlado_examen/rt_nonfinite.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = main_controlado_examen_acc.obj main_controlado_examen_acc_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj c_mexapi_version.obj
...
main_controlado_examen_acc.obj : $(START_DIR)/slprj/accel/main_controlado_examen/main_controlado_examen_acc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


main_controlado_examen_acc_data.obj : $(START_DIR)/slprj/accel/main_controlado_examen/main_controlado_examen_acc_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/slprj/accel/main_controlado_examen/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.obj : $(START_DIR)/slprj/accel/main_controlado_examen/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/accel/main_controlado_examen/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
