...
## Generated on : Sun Jan 15 19:23:58 2023
...
PRODUCT = ./main_controlado_acc.lib
...
%.obj : $(START_DIR)/slprj/accel/main_controlado/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/main_controlado/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
