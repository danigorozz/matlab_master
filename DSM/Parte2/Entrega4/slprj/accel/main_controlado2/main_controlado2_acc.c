...
#include "main_controlado2_acc_private.h"
#include <stdio.h>
...
main_controlado2_RMS_Init ( SimStruct * S , B_RMS_main_controlado2_T * localB
, DW_RMS_main_controlado2_T * localDW , P_RMS_main_controlado2_T * localP ,
X_RMS_main_controlado2_T * localX ) { localX -> integrator_CSTATE_f = localP
...
main_controlado2_RMS_Disable ( SimStruct * S , DW_RMS_main_controlado2_T *
localDW ) { localDW -> RMS_MODE = false ; } void main_controlado2_RMS (
...
XDis_RMS_main_controlado2_T * localXdis ) { int32_T isHit ; boolean_T
...
main_controlado2_RMS_Disable ( S , localDW ) ; } } } if ( localDW -> RMS_MODE
...
; localB -> B_0_1_0 = main_controlado2_acc_rt_TDelayInterpolate ( tMinusDelay
...
B_0_10_0 = main_controlado2_acc_rt_TDelayInterpolate ( tMinusDelay , 0.0 , *
...
main_controlado2_acc_rt_TDelayUpdateTailOrGrowBuf ( & localDW ->
...
main_controlado2_RMS_Deriv ( SimStruct * S , B_RMS_main_controlado2_T *
...
main_controlado2_RMS_ForcingFunction ( SimStruct * S ,
B_RMS_main_controlado2_T * localB , DW_RMS_main_controlado2_T * localDW ,
XDot_RMS_main_controlado2_T * localXdot ) { if ( localDW -> RMS_MODE ) {
localXdot -> integrator_CSTATE_f = localB -> B_0_21_0 ; localXdot ->
integrator_CSTATE_c = localB -> B_0_23_0 ; } else { { real_T * dx ; int_T i ;
dx = & ( localXdot -> integrator_CSTATE_f ) ; for ( i = 0 ; i < 2 ; i ++ ) {
dx [ i ] = 0.0 ; } } } } void main_controlado2_RMS_Term ( SimStruct * const S
) { } void main_controlado2_TrueRMS_Init ( SimStruct * S ,
B_TrueRMS_main_controlado2_T * localB , DW_TrueRMS_main_controlado2_T *
localDW , P_TrueRMS_main_controlado2_T * localP ,
X_TrueRMS_main_controlado2_T * localX ) { localX -> integrator_CSTATE =
localP -> P_1 ; localDW -> Memory_PreviousInput = localP -> P_6 ; localB ->
B_2_11_0 = localP -> P_0 ; } void main_controlado2_TrueRMS_Disable (
SimStruct * S , DW_TrueRMS_main_controlado2_T * localDW ) { localDW ->
TrueRMS_MODE = false ; } void main_controlado2_TrueRMS ( SimStruct * S ,
boolean_T rtu_Enable , real_T rtu_In , B_TrueRMS_main_controlado2_T * localB
, DW_TrueRMS_main_controlado2_T * localDW , P_TrueRMS_main_controlado2_T *
localP , X_TrueRMS_main_controlado2_T * localX ,
XDis_TrueRMS_main_controlado2_T * localXdis ) { int32_T isHit ; isHit =
...
ssSetBlockStateForSolverChangedAtMajorStep ( S ) ; localXdis ->
integrator_CSTATE = 1 ; main_controlado2_TrueRMS_Disable ( S , localDW ) ; }
...
main_controlado2_acc_rt_TDelayInterpolate ( tMinusDelay , 0.0 , * uBuffer ,
...
{ localDW -> Sqrt_DWORK1 = 1 ; } } } } void main_controlado2_TrueRMS_Update (
SimStruct * S , B_TrueRMS_main_controlado2_T * localB ,
DW_TrueRMS_main_controlado2_T * localDW , P_TrueRMS_main_controlado2_T *
localP ) { int32_T isHit ; if ( localDW -> TrueRMS_MODE ) { { real_T * *
...
S , 1 , 0 ) ; if ( isHit != 0 ) { localDW -> Memory_PreviousInput = localB ->
B_2_8_0 ; } } } void main_controlado2_TrueRMS_Deriv ( SimStruct * S ,
B_TrueRMS_main_controlado2_T * localB , DW_TrueRMS_main_controlado2_T *
localDW , XDot_TrueRMS_main_controlado2_T * localXdot ) { if ( localDW ->
TrueRMS_MODE ) { localXdot -> integrator_CSTATE = localB -> B_2_9_0 ; } else
{ localXdot -> integrator_CSTATE = 0.0 ; } } void
main_controlado2_TrueRMS_ForcingFunction ( SimStruct * S ,
B_TrueRMS_main_controlado2_T * localB , DW_TrueRMS_main_controlado2_T *
localDW , XDot_TrueRMS_main_controlado2_T * localXdot ) { if ( localDW ->
TrueRMS_MODE ) { localXdot -> integrator_CSTATE = localB -> B_2_9_0 ; } else
{ localXdot -> integrator_CSTATE = 0.0 ; } } void main_controlado2_TrueRMS_ZC
( SimStruct * S , B_TrueRMS_main_controlado2_T * localB ,
DW_TrueRMS_main_controlado2_T * localDW , P_TrueRMS_main_controlado2_T *
localP , ZCV_TrueRMS_main_controlado2_T * localZCSV ) { if ( localDW ->
TrueRMS_MODE ) { localZCSV -> Saturationtoavoidnegativesqrt_UprLim_ZC =
localB -> B_2_8_0 - localP -> P_7 ; localZCSV ->
Saturationtoavoidnegativesqrt_LwrLim_ZC = localB -> B_2_8_0 - localP -> P_8 ;
} else { { real_T * zcsv = & ( localZCSV ->
Saturationtoavoidnegativesqrt_UprLim_ZC ) ; int_T i ; for ( i = 0 ; i < 2 ; i
++ ) { zcsv [ i ] = 0.0 ; } } } } void main_controlado2_TrueRMS_Term (
SimStruct * const S ) { } static void mdlOutputs ( SimStruct * S , int_T tid
) { B_main_controlado2_T * _rtB ; DW_main_controlado2_T * _rtDW ;
P_main_controlado2_T * _rtP ; X_main_controlado2_T * _rtX ; real_T ratio ;
real_T taskTimeV ; int32_T isHit ; uint32_T numCycles ; _rtDW = ( (
DW_main_controlado2_T * ) ssGetRootDWork ( S ) ) ; _rtX = ( (
X_main_controlado2_T * ) ssGetContStates ( S ) ) ; _rtP = ( (
P_main_controlado2_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_main_controlado2_T * ) _ssGetModelBlockIO ( S ) ) ; isHit = ssIsSampleHit (
...
-> justEnabled = 0 ; if ( taskTimeV >= _rtP -> P_11 ) { ratio = ( taskTimeV -
_rtP -> P_11 ) / _rtP -> P_9 ; numCycles = ( uint32_T ) muDoubleScalarFloor (
ratio ) ; if ( muDoubleScalarAbs ( ( real_T ) ( numCycles + 1U ) - ratio ) <
DBL_EPSILON * ratio ) { numCycles ++ ; } _rtDW -> numCompleteCycles =
numCycles ; ratio = ( ( real_T ) numCycles * _rtP -> P_9 + _rtP -> P_11 ) +
_rtP -> P_10 * _rtP -> P_9 / 100.0 ; if ( taskTimeV < ratio ) { _rtDW ->
currentValue = 1 ; _rtDW -> nextTime = ratio ; } else { _rtDW -> currentValue
= 0 ; _rtDW -> nextTime = ( real_T ) ( numCycles + 1U ) * _rtP -> P_9 + _rtP
-> P_11 ; } } else { _rtDW -> numCompleteCycles = _rtP -> P_11 != 0.0 ? - 1 :
0 ; _rtDW -> currentValue = 0 ; _rtDW -> nextTime = _rtP -> P_11 ; } } else
if ( _rtDW -> nextTime <= taskTimeV ) { if ( _rtDW -> currentValue == 1 ) {
_rtDW -> currentValue = 0 ; _rtDW -> nextTime = ( real_T ) ( _rtDW ->
numCompleteCycles + 1LL ) * _rtP -> P_9 + _rtP -> P_11 ; } else { _rtDW ->
numCompleteCycles ++ ; _rtDW -> currentValue = 1 ; _rtDW -> nextTime = ( _rtP
-> P_10 * _rtP -> P_9 * 0.01 + ( real_T ) _rtDW -> numCompleteCycles * _rtP
-> P_9 ) + _rtP -> P_11 ; } } _ssSetVarNextHitTime ( S , 0 , _rtDW ->
nextTime ) ; if ( _rtDW -> currentValue == 1 ) { _rtB -> B_5_0_0 = _rtP ->
P_8 ; } else { _rtB -> B_5_0_0 = 0.0 ; } } _rtB -> B_5_1_0 [ 0 ] = _rtB ->
B_5_0_0 ; _rtB -> B_5_1_0 [ 1 ] = 0.0 ; _rtB -> B_5_1_0 [ 2 ] = 0.0 ; if (
ssIsMajorTimeStep ( S ) != 0 ) { _rtDW -> INPUT_2_1_1_Discrete [ 0 ] = ! (
_rtB -> B_5_1_0 [ 0 ] == _rtDW -> INPUT_2_1_1_Discrete [ 1 ] ) ; _rtDW ->
INPUT_2_1_1_Discrete [ 1 ] = _rtB -> B_5_1_0 [ 0 ] ; } _rtB -> B_5_1_0 [ 0 ]
= _rtDW -> INPUT_2_1_1_Discrete [ 1 ] ; _rtB -> B_5_1_0 [ 3 ] = _rtDW ->
INPUT_2_1_1_Discrete [ 0 ] ; isHit = ssIsSampleHit ( S , 3 , 0 ) ; if ( isHit
!= 0 ) { taskTimeV = ssGetTaskTime ( S , 3 ) ; if ( ssGetTNextWasAdjusted ( S
, 3 ) != 0 ) { _rtDW -> nextTime_p = _ssGetVarNextHitTime ( S , 1 ) ; } if (
_rtDW -> justEnabled_i != 0 ) { _rtDW -> justEnabled_i = 0 ; if ( taskTimeV
>= _rtP -> P_15 ) { ratio = ( taskTimeV - _rtP -> P_15 ) / _rtP -> P_13 ;
numCycles = ( uint32_T ) muDoubleScalarFloor ( ratio ) ; if (
muDoubleScalarAbs ( ( real_T ) ( numCycles + 1U ) - ratio ) < DBL_EPSILON *
ratio ) { numCycles ++ ; } _rtDW -> numCompleteCycles_k = numCycles ; ratio =
( ( real_T ) numCycles * _rtP -> P_13 + _rtP -> P_15 ) + _rtP -> P_14 * _rtP
-> P_13 / 100.0 ; if ( taskTimeV < ratio ) { _rtDW -> currentValue_h = 1 ;
_rtDW -> nextTime_p = ratio ; } else { _rtDW -> currentValue_h = 0 ; _rtDW ->
nextTime_p = ( real_T ) ( numCycles + 1U ) * _rtP -> P_13 + _rtP -> P_15 ; }
} else { _rtDW -> numCompleteCycles_k = _rtP -> P_15 != 0.0 ? - 1 : 0 ; _rtDW
-> currentValue_h = 0 ; _rtDW -> nextTime_p = _rtP -> P_15 ; } } else if (
_rtDW -> nextTime_p <= taskTimeV ) { if ( _rtDW -> currentValue_h == 1 ) {
_rtDW -> currentValue_h = 0 ; _rtDW -> nextTime_p = ( real_T ) ( _rtDW ->
numCompleteCycles_k + 1LL ) * _rtP -> P_13 + _rtP -> P_15 ; } else { _rtDW ->
numCompleteCycles_k ++ ; _rtDW -> currentValue_h = 1 ; _rtDW -> nextTime_p =
( _rtP -> P_14 * _rtP -> P_13 * 0.01 + ( real_T ) _rtDW ->
numCompleteCycles_k * _rtP -> P_13 ) + _rtP -> P_15 ; } }
_ssSetVarNextHitTime ( S , 1 , _rtDW -> nextTime_p ) ; if ( _rtDW ->
currentValue_h == 1 ) { _rtB -> B_5_2_0 = _rtP -> P_12 ; } else { _rtB ->
B_5_2_0 = 0.0 ; } } _rtB -> B_5_3_0 [ 0 ] = _rtB -> B_5_2_0 ; _rtB -> B_5_3_0
[ 1 ] = 0.0 ; _rtB -> B_5_3_0 [ 2 ] = 0.0 ; if ( ssIsMajorTimeStep ( S ) != 0
) { _rtDW -> INPUT_1_1_1_Discrete [ 0 ] = ! ( _rtB -> B_5_3_0 [ 0 ] == _rtDW
-> INPUT_1_1_1_Discrete [ 1 ] ) ; _rtDW -> INPUT_1_1_1_Discrete [ 1 ] = _rtB
-> B_5_3_0 [ 0 ] ; } _rtB -> B_5_3_0 [ 0 ] = _rtDW -> INPUT_1_1_1_Discrete [
1 ] ; _rtB -> B_5_3_0 [ 3 ] = _rtDW -> INPUT_1_1_1_Discrete [ 0 ] ; isHit =
ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { _rtB -> B_5_4_0 = _rtP ->
P_16 ; } _rtB -> B_5_5_0 = _rtX -> Integrator_CSTATE ; ssCallAccelRunBlock (
S , 5 , _rtDW ->
Synthesized_Atomic_Subsystem_For_Alg_Loop_1_Task_0_blkIdxToRun ,
SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 5 , 7 , SS_CALL_MDL_OUTPUTS
) ; ssCallAccelRunBlock ( S , 5 , 8 , SS_CALL_MDL_OUTPUTS ) ;
ssCallAccelRunBlock ( S , 5 , 9 , SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock
( S , 5 , 10 , SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 5 , 11 ,
SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 5 , 24 ,
SS_CALL_MDL_OUTPUTS ) ; _rtB -> B_5_25_0 = _rtP -> P_18 * _rtB -> B_4_0_0 ;
ssCallAccelRunBlock ( S , 5 , 28 , SS_CALL_MDL_OUTPUTS ) ;
ssCallAccelRunBlock ( S , 5 , 30 , SS_CALL_MDL_OUTPUTS ) ;
ssCallAccelRunBlock ( S , 5 , 32 , SS_CALL_MDL_OUTPUTS ) ; UNUSED_PARAMETER (
tid ) ; } static void mdlOutputsTID4 ( SimStruct * S , int_T tid ) {
B_main_controlado2_T * _rtB ; P_main_controlado2_T * _rtP ; _rtP = ( (
P_main_controlado2_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_main_controlado2_T * ) _ssGetModelBlockIO ( S ) ) ; _rtB -> B_5_1_0_m = (
_rtP -> P_19 != 0.0 ) ; _rtB -> B_5_2_0_c = ! _rtB -> B_5_1_0_m ; _rtB ->
B_5_4_0_k = ( _rtP -> P_20 != 0.0 ) ; _rtB -> B_5_5_0_c = ! _rtB -> B_5_4_0_k
; UNUSED_PARAMETER ( tid ) ; }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { B_main_controlado2_T *
_rtB ; DW_main_controlado2_T * _rtDW ; P_main_controlado2_T * _rtP ; _rtDW =
( ( DW_main_controlado2_T * ) ssGetRootDWork ( S ) ) ; _rtP = ( (
P_main_controlado2_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_main_controlado2_T * ) _ssGetModelBlockIO ( S ) ) ; { real_T * * uBuffer =
( real_T * * ) & _rtDW -> VariableTimeDelay1_PWORK . TUbufferPtrs [ 0 ] ;
real_T simTime = ssGetT ( S ) ; _rtDW -> VariableTimeDelay1_IWORK . Head = (
( _rtDW -> VariableTimeDelay1_IWORK . Head < ( _rtDW ->
VariableTimeDelay1_IWORK . CircularBufSize - 1 ) ) ? ( _rtDW ->
VariableTimeDelay1_IWORK . Head + 1 ) : 0 ) ; if ( _rtDW ->
VariableTimeDelay1_IWORK . Head == _rtDW -> VariableTimeDelay1_IWORK . Tail )
{ if ( ! main_controlado2_acc_rt_TDelayUpdateTailOrGrowBuf ( & _rtDW ->
VariableTimeDelay1_IWORK . CircularBufSize , & _rtDW ->
VariableTimeDelay1_IWORK . Tail , & _rtDW -> VariableTimeDelay1_IWORK . Head
, & _rtDW -> VariableTimeDelay1_IWORK . Last , simTime - _rtP -> P_4 ,
...
VariableTimeDelay1_IWORK . Head ] = _rtB -> B_5_2_0 ; } { real_T * * uBuffer
...
main_controlado2_acc_rt_TDelayUpdateTailOrGrowBuf ( & _rtDW ->
VariableTimeDelay_IWORK . CircularBufSize , & _rtDW ->
VariableTimeDelay_IWORK . Tail , & _rtDW -> VariableTimeDelay_IWORK . Head ,
& _rtDW -> VariableTimeDelay_IWORK . Last , simTime - _rtP -> P_6 , uBuffer ,
...
uBuffer ) [ _rtDW -> VariableTimeDelay_IWORK . Head ] = _rtB -> B_5_0_0 ; }
ssCallAccelRunBlock ( S , 4 , 9 , SS_CALL_MDL_UPDATE ) ;
main_controlado2_RMS_Update ( S , & _rtB -> RMS , & _rtDW -> RMS , & _rtP ->
RMS ) ; main_controlado2_RMS_Update ( S , & _rtB -> RMS_a , & _rtDW -> RMS_a
, & _rtP -> RMS_a ) ; main_controlado2_TrueRMS_Update ( S , & _rtB -> TrueRMS
, & _rtDW -> TrueRMS , & _rtP -> TrueRMS ) ; main_controlado2_TrueRMS_Update
...
static void mdlDerivatives ( SimStruct * S ) { B_main_controlado2_T * _rtB ;
DW_main_controlado2_T * _rtDW ; P_main_controlado2_T * _rtP ;
XDot_main_controlado2_T * _rtXdot ; _rtDW = ( ( DW_main_controlado2_T * )
ssGetRootDWork ( S ) ) ; _rtXdot = ( ( XDot_main_controlado2_T * ) ssGetdX (
S ) ) ; _rtP = ( ( P_main_controlado2_T * ) ssGetModelRtp ( S ) ) ; _rtB = (
( B_main_controlado2_T * ) _ssGetModelBlockIO ( S ) ) ; _rtXdot ->
Integrator_CSTATE = _rtB -> B_5_25_0 ; { } { } ssCallAccelRunBlock ( S , 4 ,
9 , SS_CALL_MDL_DERIVATIVES ) ; main_controlado2_RMS_Deriv ( S , & _rtB ->
RMS , & _rtDW -> RMS , & _rtXdot -> RMS ) ; main_controlado2_RMS_Deriv ( S ,
& _rtB -> RMS_a , & _rtDW -> RMS_a , & _rtXdot -> RMS_a ) ;
main_controlado2_TrueRMS_Deriv ( S , & _rtB -> TrueRMS , & _rtDW -> TrueRMS ,
& _rtXdot -> TrueRMS ) ; main_controlado2_TrueRMS_Deriv ( S , & _rtB ->
TrueRMS_e , & _rtDW -> TrueRMS_e , & _rtXdot -> TrueRMS_e ) ; }
#define MDL_FORCINGFUNCTION
static void mdlForcingFunction ( SimStruct * S ) { B_main_controlado2_T *
_rtB ; DW_main_controlado2_T * _rtDW ; P_main_controlado2_T * _rtP ;
XDot_main_controlado2_T * _rtXdot ; _rtDW = ( ( DW_main_controlado2_T * )
ssGetRootDWork ( S ) ) ; _rtXdot = ( ( XDot_main_controlado2_T * ) ssGetdX (
S ) ) ; _rtP = ( ( P_main_controlado2_T * ) ssGetModelRtp ( S ) ) ; _rtB = (
( B_main_controlado2_T * ) _ssGetModelBlockIO ( S ) ) ; _rtXdot ->
Integrator_CSTATE = _rtB -> B_5_25_0 ; { } { } ssCallAccelRunBlock ( S , 4 ,
9 , SS_CALL_MDL_FORCINGFUNCTION ) ; main_controlado2_RMS_ForcingFunction ( S
, & _rtB -> RMS , & _rtDW -> RMS , & _rtXdot -> RMS ) ;
main_controlado2_RMS_ForcingFunction ( S , & _rtB -> RMS_a , & _rtDW -> RMS_a
, & _rtXdot -> RMS_a ) ; main_controlado2_TrueRMS_ForcingFunction ( S , &
_rtB -> TrueRMS , & _rtDW -> TrueRMS , & _rtXdot -> TrueRMS ) ;
main_controlado2_TrueRMS_ForcingFunction ( S , & _rtB -> TrueRMS_e , & _rtDW
-> TrueRMS_e , & _rtXdot -> TrueRMS_e ) ; }
#define MDL_MASSMATRIX
static void mdlMassMatrix ( SimStruct * S ) { ssCallAccelRunBlock ( S , 4 , 9
, SS_CALL_MDL_MASSMATRIX ) ; }
#define MDL_ZERO_CROSSINGS
static void mdlZeroCrossings ( SimStruct * S ) { B_main_controlado2_T * _rtB
; DW_main_controlado2_T * _rtDW ; P_main_controlado2_T * _rtP ;
ZCV_main_controlado2_T * _rtZCSV ; _rtDW = ( ( DW_main_controlado2_T * )
ssGetRootDWork ( S ) ) ; _rtZCSV = ( ( ZCV_main_controlado2_T * )
ssGetSolverZcSignalVector ( S ) ) ; _rtP = ( ( P_main_controlado2_T * )
ssGetModelRtp ( S ) ) ; _rtB = ( ( B_main_controlado2_T * )
_ssGetModelBlockIO ( S ) ) ; _rtZCSV -> Saturation1_UprLim_ZC = _rtB ->
B_4_3_0 - _rtP -> P_2 ; _rtZCSV -> Saturation1_LwrLim_ZC = _rtB -> B_4_3_0 -
_rtP -> P_3 ; ssCallAccelRunBlock ( S , 4 , 9 , SS_CALL_MDL_ZERO_CROSSINGS )
; main_controlado2_TrueRMS_ZC ( S , & _rtB -> TrueRMS , & _rtDW -> TrueRMS ,
& _rtP -> TrueRMS , & _rtZCSV -> TrueRMS ) ; main_controlado2_TrueRMS_ZC ( S
, & _rtB -> TrueRMS_e , & _rtDW -> TrueRMS_e , & _rtP -> TrueRMS_e , &
_rtZCSV -> TrueRMS_e ) ; } static void mdlInitializeSizes ( SimStruct * S ) {
ssSetChecksumVal ( S , 0 , 1015384420U ) ; ssSetChecksumVal ( S , 1 ,
48976888U ) ; ssSetChecksumVal ( S , 2 , 1237452871U ) ; ssSetChecksumVal ( S
, 3 , 3178161934U ) ; { mxArray * slVerStructMat = ( NULL ) ; mxArray *
...
DW_main_controlado2_T ) ) { ssSetErrorStatus ( S ,
"Unexpected error: Internal DWork sizes do "
"not match for accelerator mex file." ) ; } if ( ssGetSizeofGlobalBlockIO ( S
) != sizeof ( B_main_controlado2_T ) ) { ssSetErrorStatus ( S ,
"Unexpected error: Internal BlockIO sizes do "
"not match for accelerator mex file." ) ; } { int ssSizeofParams ;
ssGetSizeofParams ( S , & ssSizeofParams ) ; if ( ssSizeofParams != sizeof (
P_main_controlado2_T ) ) { static char msg [ 256 ] ; sprintf ( msg ,
"Unexpected error: Internal Parameters sizes do "
"not match for accelerator mex file." ) ; } } _ssSetModelRtp ( S , ( real_T *
) & main_controlado2_rtDefaultP ) ; if ( ssGetSizeofDWork ( S ) == sizeof (
DW_main_controlado2_T ) ) { { ( ( DW_main_controlado2_T * ) ssGetRootDWork (
S ) ) -> STATE_1_MASS_MATRIX_PR = 1 ; } } rt_InitInfAndNaN ( sizeof ( real_T
) ) ; ( ( P_main_controlado2_T * ) ssGetModelRtp ( S ) ) -> TrueRMS_e . P_7 =
rtInf ; ( ( P_main_controlado2_T * ) ssGetModelRtp ( S ) ) -> TrueRMS . P_7 =
