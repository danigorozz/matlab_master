...
ssCallAccelRunBlock ( S , 5 , 11 , SS_CALL_MDL_OUTPUTS ) ;
ssCallAccelRunBlock ( S , 5 , 24 , SS_CALL_MDL_OUTPUTS ) ; _rtB -> B_5_25_0 =
_rtP -> P_12 * _rtB -> B_4_0_0 ; ssCallAccelRunBlock ( S , 5 , 28 ,
...
_rtB -> B_5_0_0_m = _rtP -> P_13 ; _rtB -> B_5_2_0_c = ( _rtP -> P_14 != 0.0
) ; _rtB -> B_5_3_0_k = ! _rtB -> B_5_2_0_c ; _rtB -> B_5_5_0_c = ( _rtP ->
P_15 != 0.0 ) ; _rtB -> B_5_6_0_b = ! _rtB -> B_5_5_0_c ; UNUSED_PARAMETER (
tid ) ; }
#define MDL_UPDATE
...
, 4 , 11 , SS_CALL_MDL_UPDATE ) ; main_controlado_RMS_Update ( S , & _rtB ->
...
B_5_25_0 ; ssCallAccelRunBlock ( S , 4 , 11 , SS_CALL_MDL_DERIVATIVES ) ;
...
B_5_25_0 ; ssCallAccelRunBlock ( S , 4 , 11 , SS_CALL_MDL_FORCINGFUNCTION ) ;
...
( S ) ) ; _rtZCSV -> Saturation1_UprLim_ZC = _rtB -> B_4_3_0 - _rtP -> P_2 ;
_rtZCSV -> Saturation1_LwrLim_ZC = _rtB -> B_4_3_0 - _rtP -> P_3 ;
ssCallAccelRunBlock ( S , 4 , 11 , SS_CALL_MDL_ZERO_CROSSINGS ) ;
...
ssSetChecksumVal ( S , 0 , 2923533691U ) ; ssSetChecksumVal ( S , 1 ,
809799565U ) ; ssSetChecksumVal ( S , 2 , 2597474447U ) ; ssSetChecksumVal (
S , 3 , 3760765400U ) ; { mxArray * slVerStructMat = ( NULL ) ; mxArray *
