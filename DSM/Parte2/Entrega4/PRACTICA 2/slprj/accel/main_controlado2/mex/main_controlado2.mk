...
## Generated on : Mon Jan 16 19:18:26 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/main_controlado2_acc.mexw64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/main_controlado2_acc.mexw64
...
SRCS = $(START_DIR)/slprj/accel/main_controlado2/main_controlado2_acc.c $(START_DIR)/slprj/accel/main_controlado2/main_controlado2_acc_data.c $(START_DIR)/slprj/accel/main_controlado2/rtGetInf.c $(START_DIR)/slprj/accel/main_controlado2/rtGetNaN.c $(START_DIR)/slprj/accel/main_controlado2/rt_nonfinite.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = main_controlado2_acc.obj main_controlado2_acc_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj c_mexapi_version.obj
...
main_controlado2_acc.obj : $(START_DIR)/slprj/accel/main_controlado2/main_controlado2_acc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


main_controlado2_acc_data.obj : $(START_DIR)/slprj/accel/main_controlado2/main_controlado2_acc_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/slprj/accel/main_controlado2/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.obj : $(START_DIR)/slprj/accel/main_controlado2/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/accel/main_controlado2/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
