...
## Generated on : Sun Jan 15 19:24:01 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/main_controlado_acc.mexw64
...
PRODUCT_NAME              = main_controlado
MAKEFILE                  = main_controlado.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2021b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2021b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/Daniel/MATLAB/Projects/Master/DSM/Parte2/Entrega4/PRACTI~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = main_controlado_comp.rsp
CMD_FILE                  = main_controlado.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/main_controlado_acc.mexw64
...
SRCS = $(START_DIR)/slprj/accel/main_controlado/main_controlado_acc.c $(START_DIR)/slprj/accel/main_controlado/main_controlado_acc_data.c $(START_DIR)/slprj/accel/main_controlado/rtGetInf.c $(START_DIR)/slprj/accel/main_controlado/rtGetNaN.c $(START_DIR)/slprj/accel/main_controlado/rt_nonfinite.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = main_controlado_acc.obj main_controlado_acc_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj c_mexapi_version.obj
...
main_controlado_acc.obj : $(START_DIR)/slprj/accel/main_controlado/main_controlado_acc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


main_controlado_acc_data.obj : $(START_DIR)/slprj/accel/main_controlado/main_controlado_acc_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/slprj/accel/main_controlado/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.obj : $(START_DIR)/slprj/accel/main_controlado/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/accel/main_controlado/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
