###########################################################################
## Makefile generated for component 'CONTROLADOR'. 
## 
## Makefile     : CONTROLADOR.mk
## Generated on : Mon Jan 16 18:46:29 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/CONTROLADOR_acc.mexw64
...
START_DIR                 = C:/Users/Daniel/MATLAB/Projects/Master/DSM/Parte2/Entrega4
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = CONTROLADOR_comp.rsp
CMD_FILE                  = CONTROLADOR.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/CONTROLADOR_acc.mexw64
...
DEFINES_STANDARD = -DMODEL=CONTROLADOR -DNUMST=2 -DNCSTATES=48 -DHAVESTDIO -DMDL_REF_SIM_TGT=1
...
SRCS = $(START_DIR)/slprj/accel/CONTROLADOR/CONTROLADOR_acc.c $(START_DIR)/slprj/accel/CONTROLADOR/CONTROLADOR_acc_data.c $(START_DIR)/slprj/accel/CONTROLADOR/rtGetInf.c $(START_DIR)/slprj/accel/CONTROLADOR/rtGetNaN.c $(START_DIR)/slprj/accel/CONTROLADOR/rt_nonfinite.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = CONTROLADOR_acc.obj CONTROLADOR_acc_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj c_mexapi_version.obj
...
CONTROLADOR_acc.obj : $(START_DIR)/slprj/accel/CONTROLADOR/CONTROLADOR_acc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


CONTROLADOR_acc_data.obj : $(START_DIR)/slprj/accel/CONTROLADOR/CONTROLADOR_acc_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/slprj/accel/CONTROLADOR/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.obj : $(START_DIR)/slprj/accel/CONTROLADOR/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/accel/CONTROLADOR/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
