...
## Generated on : Mon Jan 16 18:46:27 2023
## Final product: ./CONTROLADOR_acc.lib
...
%.obj : $(START_DIR)/slprj/accel/CONTROLADOR/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/CONTROLADOR/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
