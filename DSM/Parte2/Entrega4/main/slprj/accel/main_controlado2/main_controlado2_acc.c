...
-> justEnabled = 0 ; if ( taskTimeV >= _rtP -> P_12 ) { ratio = ( taskTimeV -
_rtP -> P_12 ) / _rtP -> P_10 ; numCycles = ( uint32_T ) muDoubleScalarFloor
( ratio ) ; if ( muDoubleScalarAbs ( ( real_T ) ( numCycles + 1U ) - ratio )
< DBL_EPSILON * ratio ) { numCycles ++ ; } _rtDW -> numCompleteCycles =
numCycles ; ratio = ( ( real_T ) numCycles * _rtP -> P_10 + _rtP -> P_12 ) +
_rtP -> P_11 * _rtP -> P_10 / 100.0 ; if ( taskTimeV < ratio ) { _rtDW ->
currentValue = 1 ; _rtDW -> nextTime = ratio ; } else { _rtDW -> currentValue
= 0 ; _rtDW -> nextTime = ( real_T ) ( numCycles + 1U ) * _rtP -> P_10 + _rtP
-> P_12 ; } } else { _rtDW -> numCompleteCycles = _rtP -> P_12 != 0.0 ? - 1 :
0 ; _rtDW -> currentValue = 0 ; _rtDW -> nextTime = _rtP -> P_12 ; } } else
if ( _rtDW -> nextTime <= taskTimeV ) { if ( _rtDW -> currentValue == 1 ) {
_rtDW -> currentValue = 0 ; _rtDW -> nextTime = ( real_T ) ( _rtDW ->
numCompleteCycles + 1LL ) * _rtP -> P_10 + _rtP -> P_12 ; } else { _rtDW ->
numCompleteCycles ++ ; _rtDW -> currentValue = 1 ; _rtDW -> nextTime = ( _rtP
-> P_11 * _rtP -> P_10 * 0.01 + ( real_T ) _rtDW -> numCompleteCycles * _rtP
-> P_10 ) + _rtP -> P_12 ; } } _ssSetVarNextHitTime ( S , 0 , _rtDW ->
nextTime ) ; if ( _rtDW -> currentValue == 1 ) { _rtB -> B_5_0_0 = _rtP ->
P_9 ; } else { _rtB -> B_5_0_0 = 0.0 ; } } _rtB -> B_5_1_0 [ 0 ] = _rtB ->
...
>= _rtP -> P_16 ) { ratio = ( taskTimeV - _rtP -> P_16 ) / _rtP -> P_14 ;
...
( ( real_T ) numCycles * _rtP -> P_14 + _rtP -> P_16 ) + _rtP -> P_15 * _rtP
-> P_14 / 100.0 ; if ( taskTimeV < ratio ) { _rtDW -> currentValue_h = 1 ;
_rtDW -> nextTime_p = ratio ; } else { _rtDW -> currentValue_h = 0 ; _rtDW ->
nextTime_p = ( real_T ) ( numCycles + 1U ) * _rtP -> P_14 + _rtP -> P_16 ; }
} else { _rtDW -> numCompleteCycles_k = _rtP -> P_16 != 0.0 ? - 1 : 0 ; _rtDW
-> currentValue_h = 0 ; _rtDW -> nextTime_p = _rtP -> P_16 ; } } else if (
_rtDW -> nextTime_p <= taskTimeV ) { if ( _rtDW -> currentValue_h == 1 ) {
_rtDW -> currentValue_h = 0 ; _rtDW -> nextTime_p = ( real_T ) ( _rtDW ->
numCompleteCycles_k + 1LL ) * _rtP -> P_14 + _rtP -> P_16 ; } else { _rtDW ->
numCompleteCycles_k ++ ; _rtDW -> currentValue_h = 1 ; _rtDW -> nextTime_p =
( _rtP -> P_15 * _rtP -> P_14 * 0.01 + ( real_T ) _rtDW ->
numCompleteCycles_k * _rtP -> P_14 ) + _rtP -> P_16 ; } }
_ssSetVarNextHitTime ( S , 1 , _rtDW -> nextTime_p ) ; if ( _rtDW ->
currentValue_h == 1 ) { _rtB -> B_5_2_0 = _rtP -> P_13 ; } else { _rtB ->
...
P_17 ; } _rtB -> B_5_5_0 = _rtX -> Integrator_CSTATE ; ssCallAccelRunBlock (
S , 5 , _rtDW ->
...
SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 5 , 25 ,
SS_CALL_MDL_OUTPUTS ) ; _rtB -> B_5_26_0 = _rtP -> P_19 * _rtB -> B_4_0_0 ;
ssCallAccelRunBlock ( S , 5 , 29 , SS_CALL_MDL_OUTPUTS ) ;
ssCallAccelRunBlock ( S , 5 , 31 , SS_CALL_MDL_OUTPUTS ) ;
ssCallAccelRunBlock ( S , 5 , 33 , SS_CALL_MDL_OUTPUTS ) ; UNUSED_PARAMETER (
...
_rtP -> P_20 != 0.0 ) ; _rtB -> B_5_2_0_c = ! _rtB -> B_5_1_0_m ; _rtB ->
B_5_4_0_k = ( _rtP -> P_21 != 0.0 ) ; _rtB -> B_5_5_0_c = ! _rtB -> B_5_4_0_k
...
, & _rtDW -> VariableTimeDelay1_IWORK . Last , simTime - _rtP -> P_5 ,
...
ssCallAccelRunBlock ( S , 4 , 10 , SS_CALL_MDL_UPDATE ) ;
...
Integrator_CSTATE = _rtB -> B_5_26_0 ; { } { } ssCallAccelRunBlock ( S , 4 ,
10 , SS_CALL_MDL_DERIVATIVES ) ; main_controlado2_RMS_Deriv ( S , & _rtB ->
...
( B_main_controlado2_T * ) _ssGetModelBlockIO ( S ) ) ; _rtXdot ->
Integrator_CSTATE = _rtB -> B_5_26_0 ; { } { } ssCallAccelRunBlock ( S , 4 ,
10 , SS_CALL_MDL_FORCINGFUNCTION ) ; main_controlado2_RMS_ForcingFunction ( S
...
_rtP -> P_3 ; ssCallAccelRunBlock ( S , 4 , 10 , SS_CALL_MDL_ZERO_CROSSINGS )
...
ssSetChecksumVal ( S , 0 , 2609924977U ) ; ssSetChecksumVal ( S , 1 ,
449434039U ) ; ssSetChecksumVal ( S , 2 , 818622102U ) ; ssSetChecksumVal ( S
, 3 , 2709909811U ) ; { mxArray * slVerStructMat = ( NULL ) ; mxArray *
