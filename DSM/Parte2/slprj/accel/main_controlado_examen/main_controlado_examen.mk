...
## Generated on : Fri Jan 20 13:36:34 2023
## Final product: ./main_controlado_examen_acc.lib
...
PRODUCT = ./main_controlado_examen_acc.lib
...
%.obj : $(START_DIR)/slprj/accel/main_controlado_examen/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/main_controlado_examen/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
